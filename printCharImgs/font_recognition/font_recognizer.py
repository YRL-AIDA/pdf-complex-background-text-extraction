...
class FontRecognizer:
    ...
    def __restore_text(self, pdf_path, dictionary, start=0, end=0):
        ...
        return text
D:\rep\fonts-recognition\printCharImgs\data\pdfdata\extracted_fonts
D:\rep\fonts-recognition\printCharImgs\pdfdata/extracted_fonts/
    def __match_glyphs_and_encoding_for_all(self):
        img_folders = self.reader.get_glyphs_path()
        img_folders = os.path.join(os.path.dirname(os.path.abspath(__file__)), img_folders)
        ...
        print(os.path.exists(extracted_fonts_folder))
